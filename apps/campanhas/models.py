...
class Campanha(models.Model):
    ...
    dataHoraAtivacao = models.DateField(editable=True, blank=False, help_text='Quando as mensagens de alerta da campanha devem ser disparadas. Ex: 12/12/2020 10:00:00', verbose_name='Quando a campanha deve ser exibida?')
    dataHoraInativacao = models.DateField(editable=True, blank=False, help_text='Quando a campanha deve tornar-se inativa. Ex: 12/12/2020 10:00:00', verbose_name='Quando a campanha deve parar de ser exibida?')
